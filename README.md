...
|130|Voor deze issue is aan mij opgedragen een stuk code opnieuw te schrijven om een pointcloud te maken.|[Code Plot_Trajectory](https://github.com/BobvanElburg/Portfolio_kb-47/blob/master/Eigen%20notebooks/plot_trajectory.ipynb)|
